...
<div id="map_buttons">
    <button id="b1" class="directions_button btn btn-primary btn-xs ladda-button" data-style="zoom-in"
            onclick="calcRoute( function() { l1.stop(); l2.stop(); l3.stop(); });"><span class="ladda-label">Trazar Ruta</span>
    </button>
    <button class="submit_button btn btn-primary btn-xs" type="submit" name="connect"
    ...
    <button id="hide_traffic" class="submit_button weather white btn btn-success btn-xs" style="display:none"
...
<div class="row">
    <div class="col-md-12">
                    ...
                    <form name="itiform" id="itiform" class="form-horizontal" method="post"
                        ...
                        <div id="tools_display" class="form-group" style="display:none;">
                            <div class="col-sm-12 text-right">
                                <button type="button" class="btn btn-primary" onclick="displayDirections()">
                                    Ver detalle de ruta
                                </button>
                            </div>
                        </div>
		...
		&lt;/div&gt;">
                            <li class="coordinate_container">
                                <div class="form-inline">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div id="dp_itibundle_itinerarytype_coordinates_0"><input
                                                    type="text"
                                                    id="dp_itibundle_itinerarytype_coordinates_0_ordre"
                                                    name="dp_itibundle_itinerarytype[coordinates][0][ordre]"
                                                    readonly="readonly" class="class_ordre form-control"
                                                    style="display:none;" style_marker="width:8%;"
                                                    style=" display:none;" value="1"/>
                                                            <span class="order_marker text-center table-cell"
                                                                  style="width:8%;">1</span>
                                                <input type="text"
                                                       id="dp_itibundle_itinerarytype_coordinates_0_address"
                                                       name="dp_itibundle_itinerarytype[coordinates][0][address]"
                                                       class="class_address form-control" style="width:50%;"
                                                       data-place="0" style=" width:50%;"/>
                                                <input type="text"
                                                       id="dp_itibundle_itinerarytype_coordinates_0_latitude"
                                                       name="dp_itibundle_itinerarytype[coordinates][0][latitude]"
                                                       required="required"
                                                       class="class_latitude class_coordinate form-control"
                                                       style="width:21%;" placeholder="Lat"
                                                       style=" width:21%;"/>
                                                <input type="text"
                                                       id="dp_itibundle_itinerarytype_coordinates_0_longitude"
                                                       name="dp_itibundle_itinerarytype[coordinates][0][longitude]"
                                                       required="required"
                            ...
                            <li id="new_link_li" class="ui-state-disabled">
                                <div class="row">
                                    <div class="col-sm-12 text-right">
                                        <button id="add_poi_li" class="btn btn-primary">Agregar Punto</button>
                                        <button id="b2"
                        ...
                        <h3 class="label-1">Opciones de Recorrido</h3>

                        <div class="form-group"><label class="col-sm-3 control-label label-2 required"
                                                       for="dp_itibundle_itinerarytype_mode">Carretera</label>

                            <div class="col-sm-9">
                                <select id="carretera"
                                        name="txtCarretera" class="form-control">
                                    <option >Selecciona una opción...</option>
                                    <option value="Asfaltada">Asfaltada</option>
                                    <option value="Terrazeria">Terrazeria</option>
                                    <option value="Empedrado">Empedrado</option>
                                    <option value="Asfaltada/Empedrado">Asfaltada/Empedrado</option>
                                    <option value="Terrazería/Asfaltada">Terrazería/Asfaltada</option>
                                </select>
                            </div>
                        </div>

                        <div class="form-group"><label class="col-sm-3 control-label label-2 required"
                                                       for="dp_itibundle_itinerarytype_mode">Transporte</label>

                            <div class="col-sm-9">
                                <select id="dp_itibundle_itinerarytype_mode"
                                        name="dp_itibundle_itinerarytype[mode]" class="form-control transporte">
                        ...
                        <div class="form-group"><label class="col-sm-3 control-label label-2 required"
                                                       for="dp_itibundle_itinerarytype_itiName">Día</label>
                        ...
                        <div class="form-group"><label class="col-sm-3 control-label label-2 required"
                                                       for="dp_itibundle_itinerarytype_itiName">Hotel</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group"><label class="col-sm-3 control-label label-2 required"
                                                       for="dp_itibundle_itinerarytype_itiName">Bioma</label>
                            <div class="col-sm-9">
                                <input type="text" id="bioma"
                                       name="txtBioma"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group"><label class="col-sm-3 control-label label-2 required"
                                                       for="dp_itibundle_itinerarytype_itiName">Inicio</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group"><label class="col-sm-3 control-label label-2 required"
                                                       for="dp_itibundle_itinerarytype_itiName">Fin</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group"><label class="col-sm-3 control-label label-2 required"
                                                       for="dp_itibundle_itinerarytype_status">Actividades a realizar</label>

                            <div class="col-sm-9">
                                <textarea id="actividad"  class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group"><label class="col-sm-3 control-label label-2"
                                                       for="dp_itibundle_itinerarytype_description">Lugares a visitar: </label>
                            <div class="col-sm-9">
                                <textarea id="lugares"
                                          name="txtLugarVisita"
                        ...
                        <div class="col-sm-9">
                            <input type="hidden" id="dp_itibundle_itinerarytype__token"
                                   ...
                                   value="ebd97bc6ec9a78d84f6d869a206c19c2ec7e9c58"/>
                        </div>

                        <div class="form-group">
                            <div class="col-sm-12 text-right">
                                <input id="form_orig_submit" class="submit_button btn btn-primary"
                                       type="submit" name="connect" value="Guardar">
                                <button id="b3" class="directions_button btn btn-primary ladda-button"
                                        data-style="zoom-in"
                                        onclick="calcRoute( function() { l1.stop(); l2.stop(); l3.stop(); });">
                                    <span class="ladda-label">Trazar Ruta</span></button>
                                <img id="loader2" style="display:none;" src="images/ajax-loader.gif"/>
                            </div>
                        </div>
                    </form>
                </div>
                <div id="directionsPanelWrapper" style="display: none;">
                    <form class="form-horizontal">
                        <div class="form-group">
                            <div class="col-sm-12 text-right">
                                <a class="button_link btn btn-primary" href="javascript:window.print();"
                                   title="Imprimer">Print</a>
                                <button type="button" class="btn btn-primary" onclick="displayInfo()"><span
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var data={"carretera":"","transporte":"","dia":"","hotel":"","bioma":"","horaInicio":"","horaFin":"","actividad":"","distancia":"","lugares":"",sitios:[]};
        $("#form_orig_submit").on('click', function (evt) {
            ...
            datos.find(".coordinate_container").each(function(){
                sitios.push({"nombre":$("#dp_itibundle_itinerarytype_coordinates_"+indice+"_address").val(),"longitud":$("#dp_itibundle_itinerarytype_coordinates_"+indice+"_longitude").val(),"latitud":$("#dp_itibundle_itinerarytype_coordinates_"+indice+"_latitude").val()});
                indice++;
            });
